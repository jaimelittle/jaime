...
<table lay-filter="tabledata">
    <thead>
    <tr>
        <th lay-data="{align:'center',field:'a' }">分类名称</th>
    ...
    <c:forEach items="${catalogList}" var="catalog">
        <tr>
            <td align="center">${catalog.catalogname}</td>
            <td align="center">
                <a
                        href="admin/catalog/getById.action?id=${catalog.catalogid}">编辑</a>
                <a
                        href="admin/catalog/delete.action?id=${catalog.catalogid}"
    ...
    <TR align="right">
        <TD>
            <form action="" method="get" name="formpage">
                ...
                <!--//用于给上面javascript传值-->
                <input type="hidden" name="jumpurl" value="admin/catalog/getAll.do?"/>
                <!--//用于给上面javascript传值-->
