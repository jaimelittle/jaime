...
<table lay-filter="tabledata">
    ...
    <tr>
        ...
        <th lay-data="{align:'center',field:'b' }">回复</th>
        <th lay-data="{align:'center',field:'c' }">回复日期</th>
    ...
    <c:forEach items="${rebbsList}" var="rebbs">
        <tr>
            ...
            <td align="center">
                <fmt:formatDate value="${rebbs.addtime}" pattern="MM月dd日"/>
            </td>
            <td align="center"><a
                    href="admin/rebbs/delete.action?id=${rebbs.rebbsid}"
    ...
    <TR align="right">
        <TD>
            <form action="" method="get" name="formpage">
                ...
                <!--//用于给上面javascript传值-->
                <input type="hidden" name="jumpurl" value="admin/rebbs/getAll.action?"/>
                <!--//用于给上面javascript传值-->
