...
<table lay-filter="tabledata">
    ...
    <tr>
        ...
        <th lay-data="{align:'center',field:'c' }">联系方式</th>
        <th lay-data="{align:'center',field:'d' }">操作</th>
    </tr>
    </thead>
    <tbody>
    <c:forEach items="${adminList}" var="admin">
        <tr>
            ...
            <td align="center">
                <a href="admin/admin/getById.action?id=${admin.adminid}">编辑</a>

                <a href="admin/admin/delete.action?id=${admin.adminid}"
    ...
    <TR align="right">
        <TD>
            <form action="" method="get" name="formpage">
                ...
                <!--//用于给上面javascript传值-->
                <input type="hidden" name="jumpurl" value="admin/admin/getAll.action?"/>
                <!--//用于给上面javascript传值-->
