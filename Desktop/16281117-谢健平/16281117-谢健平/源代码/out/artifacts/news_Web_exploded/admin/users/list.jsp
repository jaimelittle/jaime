...
<table lay-filter="tabledata">
    <thead>
    <tr>
        <th lay-data="{align:'center',field:'a' }">用户名</th>
        <th lay-data="{align:'center',field:'b' }">姓名</th>
        <th lay-data="{align:'center',field:'c' }">性别</th>
        <th lay-data="{align:'center',field:'d' }">出生日期</th>
        <th lay-data="{align:'center',field:'e' }">联系方式</th>
        <th lay-data="{align:'center',field:'f' }">注册日期</th>
    ...
    <c:forEach items="${usersList}" var="users">
        <tr>
            ...
            <td align="center">
                <fmt:formatDate value="${users.regdate}" pattern="MM月dd日"/>
            </td>
            <td align="center">
                <a
                    href="admin/users/delete.action?id=${users.usersid}"
    ...
    <TR align="right">
        <TD>
            <form action="" method="get" name="formpage">
                ...
                <!--//用于给上面javascript传值-->
                <input type="hidden" name="jumpurl" value="admin/users/getAll.action?"/>
                <!--//用于给上面javascript传值-->
